...
export default [
  {
    ...
    handler: async (req: Request, res: Response) => {
      ...
      console.log("getOne");
      controller.getOne(req, res).then((product: Product) => {
  ...
  },
  {
    ...
    handler: async (req: Request, res: Response) => {
      console.log("create");
      const controller = new ProductsController();
      controller.create(req, res).then(product => {
        res.status(200).json(product);
      });
    }
  },
  {
    ...
    handler: async (req: Request, res: Response) => {
      console.log("update");
      const controller = new ProductsController();
      controller.update(req, res).then(product => {
        res.status(200).json(product);
      });
    }
  },
  {
    ...
    handler: async (req: Request, res: Response) => {
      console.log("delete");
      const controller = new ProductsController();
      controller.delete(req, res).then(product => {
        res.status(200).json(product);
      });
    }
  }
